import { AppPricingURL, AppSignupURL, appendUrlParams } from './config.js';
...
export class PromptSendQuota {
  ...
  constructTrackingURL(isBlocked = false) {
    ...
    return appendUrlParams(trackingURL,
      `utm_source=extension&utm_medium=continuebutton&utm_campaign=QuotaPromptSend${
        this.#isAIPRMPrompt ? 'AIPRM' : 'NONAIPRM'
