...
let QuotaMessages = {
  ...
  <h3>Connect ChatGPT and AIPRM Accounts</h3>

  <p class="AIPRM__my-4">
    We are excited to announce that you can now connect your ChatGPT account with your AIPRM account.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    To use the "Favorites" prompts list, you must connect your ChatGPT account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    ...
    you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Plus</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To create a custom prompt list, you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Plus</b> plan or higher.
  ...
  <p class="AIPRM__my-4">
    To use private prompts, you must connect your ChatGPT account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    To use team prompts, you must connect your ChatGPT account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your ChatGPT account with your AIPRM account to be able to create more prompts.
    <br><br>
  ...
  UPGRADE_ACCOUNT_CUSTOM_TONE_WRITING_STYLE_POWER_CONTINUE: /*html*/ `
  <h3>Upgrade Your Account</h3>

  <p class="AIPRM__my-4">
    Upgrade to the <b>AIPRM Pro</b> plan to add your own custom Tones, Writing Styles and Power Continue actions.
    <br><br>
    <a class="AIPRM__underline" href="${AppPricingURL}">View available plans here.</a>
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To use the "AIPRM Verified Prompts" list, you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Pro</b> plan.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To view prompt template source, you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To use the Live Crawling feature, you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To use the Hide Watermark feature, you must connect your ChatGPT account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your ChatGPT account with your AIPRM account to be able to use Custom Index feature.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    Connect your ChatGPT account with your AIPRM account to be able to use Invite a Friend & Earn feature.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your ChatGPT account with your AIPRM account to extend your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your ChatGPT account with your AIPRM account to increase your daily prompt allowance.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your ChatGPT account with your AIPRM account immediately to increase your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    You cannot use more AIPRM prompts today .
    <br><br>
    To continue using the service, connect your ChatGPT account with your AIPRM account to increase your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    You can't send any more messages today.
    <br><br>
    Connect your ChatGPT account with your AIPRM account to be able to send more prompts.
    <br><br>
...
export class UserQuota {
  ...
  async fetchMessages() {
    try {
      ...
      // Inject lang parameter into all app.aiprm.com URLs in quota messages
      for (const key of Object.keys(QuotaMessages)) {
        if (typeof QuotaMessages[key] === 'string') {
          QuotaMessages[key] = QuotaMessages[key].replace(
            /href="(https:\/\/app\.aiprm\.com\/[^"]+?)"/g,
            (match, url) => `href="${appendLangParam(url)}"`
          );
          QuotaMessages[key] = QuotaMessages[key].replace(
            /href=(["'])(https:\/\/www\.aiprm\.com\/[^"']+?)\1/g,
            (match, q, url) => `href=${q}${localizeWwwURL(url)}${q}`
          );
          QuotaMessages[key] = replaceEnvironmentURLs(QuotaMessages[key]);
        }
      }
    } catch (error) {
   ...
   * (requires ChatGPT account to be connected with AIPRM account & max. private list items quota not exceeded)
   *
   * @param {import('./list.js').Lists} lists
   * @returns {boolean}
   */
  canUseFavorites(lists) {
    // ChatGPT account must be connected to AIPRM account
   ...
   * (requires ChatGPT account to be connected with AIPRM account, min. 3 private lists quota
   ...
   * (requires ChatGPT account to be connected with AIPRM account & max. private prompts quota not exceeded)
   *
  ...
  canCreatePublicPromptTemplate(ownPrompts = []) {
    // TODO: only users with connected ChatGPT and AIPRM account or all users can add public prompts?
  ...
  canAddCustomToneWritingStylePowerContinue() {
    // Plan level must be at least "PRO"
    if (this.#quota.MaxLevel >= PlanLevelNo.PRO) {
      return true;
    }

    // Show modal to upgrade account
    this.showModal(
      QuotaMessages.UPGRADE_ACCOUNT_CUSTOM_TONE_WRITING_STYLE_POWER_CONTINUE,
      AppPricingURL
    );
  ...
  canUseLiveCrawling() {
    ...
    // Show modal to upgrade account to use "Live Crawling" (or connect ChatGPT account to AIPRM account and then upgrade, if not connected)
    this.showModal(
      !this.#user.IsLinked
  ...
  canUseHideWatermark(showModal = true) {
    ...
    if (showModal) {
      // Show modal to upgrade account to use "Hide Watermark" (or connect ChatGPT account to AIPRM account and then upgrade, if not connected)
      this.showModal(
        !this.#user.IsLinked
  ...
  canUseCustomIndexes() {
    ...
    // Show modal to upgrade account to use "Custom Indexes" (or connect ChatGPT account to AIPRM account and then upgrade, if not connected)
    this.showModal(
      !this.#user.IsLinked
        ? QuotaMessages.CONNECT_ACCOUNT_DOCUMENT_INDEX_INCORRECT_PLAN
        : QuotaMessages.UPGRADE_ACCOUNT_DOCUMENT_INDEX_INCORRECT_PLAN,
  ...
  /**
   * Show modal with announcement to connect ChatGPT account to AIPRM account
   *
   * @param {boolean} isOAuth2 - whether the connect flow will use OAuth2 (if true, connectModalHelper must be provided)
   * @param {import('./connect-modal.js').ConnectModalHelper} connectModalHelper - helper for showing the connect modal in OAuth2 flow
   *
   * @returns {boolean}
   */
  connectAccountAnnouncement(isOAuth2 = false, connectModalHelper = null) {
    if (this.#user.IsLinked) {
      return false;
    }

    if (isOAuth2 && connectModalHelper) {
  ...
  showModal(message = '', actionURL = '', showMessages = false) {
    ...
    // Resolve legacy logging image for connect modals - only for connect (not upgrade) and if user is NOT eligible for OAuth2 connect flow
    let legacyLoggingImage = '';
    if (
      actionURL.startsWith(AppSignupURL) &&
      !window.AIPRM?.shouldShowOAuth2ConnectCTA?.()
    ) {
      const oauth2Config =
        window.AIPRM?.Config?.getOAuth2FeatureConfig?.() ?? null;
      ...
      if (legacyVariant.ConnectLegacy) {
        const user = window.AIPRM?.Client?.User;
        legacyLoggingImage = replaceEnvironmentURLs(
          legacyVariant.ConnectLegacy.replaceAll(
            '{{OperatorPlanType}}',
            user?.OperatorPlanType || ''
          ).replaceAll('{{OperatorERID}}', user?.OperatorERID || '')
        );
      }
    }
    ...
    if (quotaMessageModalSubmit) {
      quotaMessageModalSubmit.addEventListener('click', () => {
        ...
        // For connect cases (not upgrade), use OAuth2 if eligible
        if (
          actionURL.startsWith(AppSignupURL) &&
          window.AIPRM?.shouldShowOAuth2ConnectCTA?.()
        ) {
          window.AIPRM.oauth2Login();
        } else {
          if (actionURL.startsWith(AppSignupURL)) {
            window.AIPRM?.trackConnectEvent?.(AccessTypeNo.ConnectWeb);
          }
    ...
    // Track connect CTA shown for connect cases (not upgrade)
    if (actionURL.startsWith(AppSignupURL)) {
  ...
  hasFeatureEnabled(feature) {
    // ChatGPT account must be connected to AIPRM account before checking for features
    if (!this.#user.IsLinked) {
      return false;
    }
